...
- (void)request:(SKRequest *)request didFailWithError:(NSError *)error {
    ...
    [UIAlertView bk_showAlertViewWithTitle:NSLocalizedString(@"Failed", @"Failed") message:NSLocalizedString(@"FailedLoadProducts_Message", @"Failed to load list of products, please try again later") cancelButtonTitle:NSLocalizedString(@"Ok", @"Ok") otherButtonTitles:nil handler:nil];
}
